...
define Device/cmcc_xr30-usboffload
  DEVICE_VENDOR := CMCC
  DEVICE_MODEL := XR30 NAND USBOFFLOAD
  DEVICE_DTS := mt7981-cmcc-xr30-usboffload
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  DEVICE_PACKAGES := $(MT7981_USB_PKGS) swconfig luci-app-ksmbd luci-i18n-ksmbd-zh-cn ksmbd-utils
  SUPPORTED_DEVICES := cmcc,xr30-usboffload
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 116736k
